...
class gsp_testconsig1_correlationindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/correlation/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(correlationList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(correlationCount ?: 0)],-1)
printHtmlPart(13)
})
