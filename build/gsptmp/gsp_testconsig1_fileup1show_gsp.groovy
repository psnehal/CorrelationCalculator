...
class gsp_testconsig1_fileup1show_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fileup1/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("fileup1")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.fileup1)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.fileup1),'method':("DELETE")],2)
printHtmlPart(17)
})
